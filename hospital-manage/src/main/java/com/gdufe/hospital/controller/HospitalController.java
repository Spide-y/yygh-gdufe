package com.gdufe.hospital.controller;
...
import com.gdufe.hospital.util.Result;
...
public class HospitalController {
	...
	public Result AgreeAccountLendProject(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			//if(!HttpRequestHelper.isSignEquals(paramMap, apiService.getSignKey())) //加密后的数据对比
			if (!sign.equals(apiService.getSignKey())){
